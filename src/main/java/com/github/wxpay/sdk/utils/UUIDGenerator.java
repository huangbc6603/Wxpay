...
public class UUIDGenerator {
	 ...
	 * @return
	 */
	public static String setOrderNum20() {
...
//		buffer.append(RandomUtils.getRandomNum(8));
	 ...
	 * @return
	 */
	public static String setOrderNum16() {
		StringBuffer buffer = new StringBuffer();
		buffer.append(new SimpleDateFormat("yyMMddHHmmss").format(new Date()));
...
//		buffer.append(RandomUtils.getRandomNum(4));
	 ...
	 * @return
	 */
	public static String setOrderNum18() {
		StringBuffer buffer = new StringBuffer();
		buffer.append(new SimpleDateFormat("yyMMddHHmmss").format(new Date()));
//		buffer.append(RandomUtils.getRandomNum(6));
	 ...
	 * @return
	 */
	public static String getRechargeNum() {
		StringBuffer buffer = new StringBuffer();
//		buffer.append(TradeChannel.TRADE_RECHARGE_FRONT);
		buffer.append(new SimpleDateFormat("yyMMddHHmmss").format(new Date()));
//		buffer.append(RandomUtils.getRandomNum(4));
		return buffer.toString();
	}
